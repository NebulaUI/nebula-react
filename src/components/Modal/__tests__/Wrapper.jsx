...
//   })
//
//   it('can be closed by clicking outside of the modal', () => {
//     const $ = shallow(
//       <Modal.Overlay>
//         <Modal.Toggle>_</Modal.Toggle>
//         <Modal.Content>_</Modal.Content>
//       </Modal.Overlay>
//     )
//     expect($.hasClass('c-modal')).toBe(true)
//
//     $.childAt(0).prop('handleToggle')()
//     expect($.hasClass('c-modal is-open')).toBe(true)
//
//     $.childAt(0).prop('handleToggle')()
//     expect($.hasClass('c-modal is-open')).not.toBe(true)
//   })
// })
